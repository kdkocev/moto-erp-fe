...
export const replacePartIdsWithNumbers = (expeditionList, partList) => {
  ...
  return expeditionList.map((expedition) => ({
    ...expedition,
    part: partIdToNumberObj[expedition.part]
  }));
};
...
export const prepareMachinedPartsForTable = (expeditions) =>
  expeditions
