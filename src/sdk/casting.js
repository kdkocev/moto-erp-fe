...
export const fetchCastingList = (filters) => callUrl(get, LIST_URL, filters);
...
export const useCastingList = (filters) =>
  useFetch(fetchCastingList, [], filters); // Key for useRefreshable
